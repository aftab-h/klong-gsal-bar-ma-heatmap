...
ls_text = read_text_file('key_and_data/ls-5-8-complete.txt')
...
original_csv_path = 'key_and_data/key_3-26-24.csv'
output_csv_path = 'key_and_data/key_with_indexes.csv'
